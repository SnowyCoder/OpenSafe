...
public class CustomCipherInputStream extends FilterInputStream {
    ...
    /* the buffer holding data that have been read in from the
       ...
       Note to the original developers, please don't chose anything at
       random as it can slow down significantly your software,
       you could at least have added the buffer size as an argument
    */
    private byte[] ibuffer = new byte[64 * 1024];
